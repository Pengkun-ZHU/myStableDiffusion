...
num_inference_steps = 50  # You may decrease it for quick result, especially during debug. However 30 is roughly a lowerbound such that you can get a reasonable image.
guidance_scale = 7.5
